...
//
// On Wed Feb 19 00:59:17 PST 2025
//
//
// Ports:
// Name                         I/O  size props
...
module nm(CLK,
  ...
  // rule RL_update_state
  assign CAN_FIRE_RL_update_state = 1'd1 ;
  assign WILL_FIRE_RL_update_state = 1'd1 ;
  ...
  // register state
  assign state$D_IN = !state ;
  assign state$EN = awready && wready && bvalid || !state ;
